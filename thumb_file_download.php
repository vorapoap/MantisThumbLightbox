...
function make_thumb($from, $src, $srcv, $dest, $desired_height) {
	...
	/* read the source image */
		...
		case DISK:
			...
			break;
		case DATABASE:
			$source_image = imagecreatefromstring($srcv);
			break;
	}
...
$dest = 'cache/'.$c_file_id.'.jpg';
if (!file_exists($dest)) make_thumb($t_upload_method, $t_local_disk_file, $v_content, $dest, 500);
$v_filesize = filesize($dest);
$t_content_type = 'image/jpeg';
